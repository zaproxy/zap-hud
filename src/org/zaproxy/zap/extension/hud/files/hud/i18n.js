	...
	var messages = {
		en_GB: {
			message: {
				...
				ascan_start_scope: 'This site is not in scope.<br>In order to Active Scan the site you must add it to the scope.<br>Add the site to the scope and start Active Scanning it?',
