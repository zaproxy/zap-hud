...
public class AjaxSpiderPage extends TutorialPage {

    public static final String NAME = "AjaxSpider";

    public AjaxSpiderPage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public AjaxSpiderPage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
