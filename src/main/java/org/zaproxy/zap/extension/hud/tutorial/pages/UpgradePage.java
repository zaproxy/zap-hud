...
public class UpgradePage extends TutorialPage {

    public static final String NAME = "Upgrade";

    public UpgradePage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public UpgradePage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
