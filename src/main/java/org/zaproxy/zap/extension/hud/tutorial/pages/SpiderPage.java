...
public class SpiderPage extends TutorialPage {

    public static final String NAME = "Spider";

    public SpiderPage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public SpiderPage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
