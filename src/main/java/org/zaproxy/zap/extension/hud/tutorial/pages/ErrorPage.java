...
public class ErrorPage extends TutorialPage {

    public static final String NAME = "404";

    public ErrorPage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public ErrorPage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
