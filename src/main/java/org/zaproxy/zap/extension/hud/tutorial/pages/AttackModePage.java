...
public class AttackModePage extends TutorialPage {

    public static final String NAME = "AttackMode";

    public AttackModePage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public AttackModePage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
