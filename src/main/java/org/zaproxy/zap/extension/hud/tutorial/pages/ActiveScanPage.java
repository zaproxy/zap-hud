...
public class ActiveScanPage extends TutorialPage {

    public static final String NAME = "ActiveScan";

    public ActiveScanPage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public ActiveScanPage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
