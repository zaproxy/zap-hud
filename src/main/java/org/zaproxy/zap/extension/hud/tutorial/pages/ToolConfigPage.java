...
public class ToolConfigPage extends TutorialPage {

    public static final String NAME = "ToolConfig";

    public ToolConfigPage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public ToolConfigPage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
