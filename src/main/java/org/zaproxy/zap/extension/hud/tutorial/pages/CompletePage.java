...
public class CompletePage extends TutorialPage {

    public static final String NAME = "Complete";

    public CompletePage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public CompletePage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
