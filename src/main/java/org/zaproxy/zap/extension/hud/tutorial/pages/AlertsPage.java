...
public class AlertsPage extends TutorialPage {

    public static final String NAME = "Alerts";

    public AlertsPage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public AlertsPage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
