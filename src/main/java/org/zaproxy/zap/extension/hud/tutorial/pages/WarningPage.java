...
public class WarningPage extends TutorialPage {

    public static final String NAME = "Warning";

    public WarningPage(TutorialProxyServer tutorialProxyServer) {
        super(tutorialProxyServer);
    }

    public WarningPage(TutorialProxyServer tutorialProxyServer, TutorialPage prev) {
