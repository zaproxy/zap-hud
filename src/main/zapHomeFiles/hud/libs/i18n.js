...
const messages = {
  en_GB: {
    message: {
      ...
      ascan_start_scope_2:
        "</i> is not in scope.<br>In order to Active Scan the site you must add it to the scope.<br>Add <i>",
      ascan_start_scope_3: "</i> to the scope and start Active Scanning it?",
      ascan_stop_1: "The site <i>",
      ascan_stop_2:
        "</i> is currently getting Active Scanned. <br> Would you like to stop the Active Scan tool?",
      ascan_tool: "Active Scan",
      attack_start: "Turn off Attack Mode?",
      attack_stop:
        "Turn on Attack Mode?<br>This will cause ZAP to automatically attack all pages in scope.",
      attack_tool: "Attack Mode",
      break_continue: "Continue",
      break_drop: "Drop",
      break_http_message_title: "HTTP Message",
      break_intercept_title: "Intercepted HTTP Message",
      break_step: "Step",
      break_tool: "Break",
      common_add: "Add",
      ...
      scope_required:
        "This tool requires the current site be added to the scope, via the Scope tool.",
      scope_tool: "Scope",
      ...
      spider_start_scope_2:
        "</i> is not in scope.<br>In order to spider the site you must add it to the scope.<br>Add <i>",
      spider_start_scope_3: "</i> to the scope and start spidering it?",
      spider_stop_1: "The site <i>",
      spider_stop_2:
        "</i> is currently getting Spidered. <br> Would you like to stop the Spider tool?",
      spider_tool: "Spider",
